...
def mission(request):
    mission = "<h1>Mission</h1> <br> <p>The College of Computing and Multimedia Studies shall produce competent and innovative professionals or Technopreneurs in the Information and Communication Technology (ICT) industry adequately prepared in the practice of their profession supportive of national development goals and standards of global excellence.</p>"
    return HttpResponse(mission)

def vision(request):
    vision = "<h1>Vision</h1> <br> <p>The College of Computing and Multimedia Studies shall be a center of excellence in delivering Computing and Multimedia education.</p>"
    return HttpResponse(vision)

def objectives(request):

    obj = """<h1>Objectives</h1> <br> <ol><li>Increase faculty performance by obtaining a minimum rating of 4.00 in the semestral faculty evaluation of each faculty for the next fiveyears.</li>
    ...
    <li>Conduct a minimum of two (2) researches, IT projects or production of instructional materials annually for the next five years.Achieve a minimum of 50&amp student passing percentage in the IT certification annually for the next five years.</li>
